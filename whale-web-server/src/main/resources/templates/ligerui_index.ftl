...
<style type="text/css"> 
    ...
    #pageloading{position:absolute; left:0px; top:0px; background:white url('${springMacroRequestContext.contextPath}/static/lib/images/loading.gif') no-repeat center; width:100%; height:100%;z-index:99999;}
    .l-link{ display:block; line-height:22px; height:22px; padding-left:16px;border:1px solid white; margin:4px;}
    .l-link-over{ background:#FFEEAC; border:1px solid #DB9F00;} 
    .l-winbar{ background:#2B5A76; height:30px; position:absolute; left:0px; bottom:0px; width:100%; z-index:99999;}
    .space{ color:#E7E7E7;}
    /* 顶部 */ 
    .l-topmenu{ margin:0; padding:0; height:31px; line-height:31px; background:url('${springMacroRequestContext.contextPath}/static/lib/images/top.jpg') repeat-x bottom;  position:relative; border-top:1px solid #1D438B;  }
    .l-topmenu-logo{ color:#E7E7E7; padding-left:35px; line-height:26px;background:url('${springMacroRequestContext.contextPath}/static/lib/images/topicon.gif') no-repeat 10px 5px;}
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; "> 
        ...
        <div position="center" id="framecenter"> 
            <div tabid="home" title="我的主页" style="height:300px" >
                <iframe frameborder="0" name="home" id="home" src="${springMacroRequestContext.contextPath}/ligerui/welcome"></iframe>
            </div> 
        </div> 
